...
- **Master 1 Histoire européenne** : TD "outils numériques"  
  ...
  - [Contenu du cours (manuel LaTeX) en accès libre](https://hal.science/hal-05059653)
...
- Organisation des colloques : [#dhnord2023](https://dhnord2023.sciencesconf.org/), [#dhnord2024](https://journees-dhnord2024.sciencesconf.org/?lang=fr), [#dhnord2025](https://dhnord2025.sciencesconf.org/)
...
- Automatisation d'une chaîne d’[encodage en XML-TEI](https://gitlab.huma-num.fr/vdecraene/DicoNumFermeGe)
- Développement web du [Dictionnaire numérique de la Ferme générale](https://fermege.meshs.fr/)
...
### Master 2 – ["Technologies Numériques Appliquées à l’Histoire"](https://www.chartes.psl.eu/fr/cursus/master-technologies-numeriques-appliquees-histoire)**  
📅 *Septembre 2021 – Septembre 2022*
- Mémoire : ["Le Dictionnaire numérique de la Ferme générale (1664–1794) : du traitement à la mise en valeur des données nativement numériques"](https://github.com/ValentinDeCraene/MemoireMaster2TNAH)
- Mention : Très Bien
...
- **Référent régional de l’IR\*** [Huma-Num](https://www.huma-num.fr/)
